...
class Autocomplete extends Component {
  ...
  static defaultProps = {
    ...
    renderTextInput: props => { 
      return (
        <View style={{ paddingLeft: 8, height: 40, flex: 1, flexDirection: 'row', alignItems: 'center' }}>
          <Icon name="account-circle" style={{ paddingRight: 8 }} />
          <TextInput {...props} underlineColorAndroid='#03a9f4' />
        </View>
      ) 
    }
  };
